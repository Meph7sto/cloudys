package com.cloudys.project.configuration;
...
class ProjectFlywayConfigurationTest {
    ...
    void sharedSchemaFlywayShouldBaselineAtVersionZero() {
        ...
        assertTrue(properties.getProperty("spring.flyway.table", "").contains("project_flyway_schema_history"));
    }
